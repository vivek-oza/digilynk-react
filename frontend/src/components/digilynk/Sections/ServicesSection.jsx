    ...
    <>
      <section className="relative rounded-2xl bg-white shadow-2xl m-2 my-10 px-2 pb-2 h-full min-h-screen">
        ...
        <div className="flex flex-col justify-around space-y-2">
          <div className="flex w-full py-8 pb-6 items-center justify-center text-2xl md:text-4xl font-bold">
            Services By Digilynk
          </div>
          <div className="grid lg:grid-cols-1 grid-cols-1 gap-y-4 w-full min-h-screen">
