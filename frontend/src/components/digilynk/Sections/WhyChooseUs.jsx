...
export default function WhyChooseUs() {
    return (
        <>
            <section className="relative bg-blue-200 rounded-2xl  shadow-2xl md:mx-16 mx-4 my-10 p-5 py-16">
                <div className="flex flex-col items-center justify-center space-y-8">
                    <div className="z-20 transition-all text-center drop-shadow-2xl text-zinc-800 tracking-wide md:text-4xl text-2xl font-semibold">
                        Build
                    ...
                    <div className="z-20 text-md md:text-2xl drop-shadow-2xl text-zinc-800 md:text-center leading-relaxed mx-4 md:mx-24 lg:mx-48">
