...
export default function HeroSection() {
  return (
    <>
        <section className=' grid md:grid-cols-2 rounded-b-4xl bg-white shadow-2xl mb-40 h-full min-h-screen'>
            <Particles color='#000fff' size={1} ease={50} staticity={10} quantity={499} className='absolute size-full'></Particles>
            <div className='flex items-center justify-center'>
                <AppointmentForm />
            </div>
            <div className='relative'>
                <div className='bg-blue-900 hidden md:block rounded-br-4xl h-full absolute -z-0 right-0 bottom-0 w-6/12 '></div>
